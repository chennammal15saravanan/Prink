...
const SPREADSHEET_ID = '1S53f9TC1bXOLsLB3skQWyDWYIlSFD7WtyEm_bSOLhJs';
let docCache = null;
...
const getDoc = async () => {
  ...
  if (!fs.existsSync(credsPath)) {
    console.warn('[SPREADSHEET SERVICE] google-credentials.json not found. Spreadsheet automation is disabled.');
    return null;
  }
