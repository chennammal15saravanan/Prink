            ...
            <tbody>
              {filteredQueue.length === 0 ? (
                ...
                <React.Fragment key={item.id}>
                  <tr id={`printer-row-${item.id}`} style={{ cursor: 'pointer', transition: 'background-color 0.2s' }} onClick={() => toggleExpand(item.id)} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#f1f5f9'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                    <td>
