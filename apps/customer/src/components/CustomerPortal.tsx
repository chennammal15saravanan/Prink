...
export default function CustomerPortal({
  ...
  const isButterfly = (order: any) => order && (order.productType === 'butterfly' || (order.product || '').toLowerCase().includes('butterfly'));
  ...
  // ===========================================================================
    ...
    const NAV_ITEMS: any[] = [
    // Simplified Navigation: Only showing Orders/Upload based on user request
